...
public class UtilsTest {
  ...
  @Test public void matchingRequestsHaveSameKey() {
    Request r1 = new TestRequest(picasso, URL, 0, null, null, null, false, false, 0, null, null);
    Request r2 = new TestRequest(picasso, URL, 0, null, null, null, false, false, 0, null, null);
    ...
    Request single1 = new TestRequest(picasso, URL, 0, null, null, t1, false, false, 0, null, null);
    List<Transformation> t2 = new ArrayList<Transformation>();
    t2.add(new TestTransformation("foo", null));
    Request single2 = new TestRequest(picasso, URL, 0, null, null, t2, false, false, 0, null, null);
    ...
    Request double1 = new TestRequest(picasso, URL, 0, null, null, t3, false, false, 0, null, null);
    ...
    Request double2 = new TestRequest(picasso, URL, 0, null, null, t4, false, false, 0, null, null);
    ...
    Request order1 = new TestRequest(picasso, URL, 0, null, null, t5, false, false, 0, null, null);
    Request order2 = new TestRequest(picasso, URL, 0, null, null, t6, false, false, 0, null, null);
